 ...
 * @author LENOVO
 */
public class FXML_disNilaiController implements Initializable {
    ...
    private void showdata(){
        ObservableList<NilaiModel> data=testFXMLDocumentController.dtnilai.Load();
        if(data!=null){            
    ...
    private void hapusklik(ActionEvent event) {
        ...
        if(a.getResult()==ButtonType.YES){
            if(testFXMLDocumentController.dtnilai.delete(s.getNPM(),s.getKodeMk())){
